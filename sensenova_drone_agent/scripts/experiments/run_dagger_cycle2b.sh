...
#
# Usage: setsid nohup bash run_dagger_cycle2b.sh > output/dagger_c2b_chain.log 2>&1 &
set -Eeuo pipefail
...
GPU=device=1
STATUS="${SDA}/output/dagger_c2b_chain_status.log"
...
DG() {
  local name="sda-dagger-c2b-$1"; shift
...
train_planner() {  # $1=RUN_ID  $2=SEED
  ...
  thermal_gate
  RUN_ID="$1" \
  MANIFEST_JSON="${W}/data/gym_drone_game_dreamer4/drone_v6_dagger2_rebal_manifest.json" \
...
st "[1/5] write drone_v6_dagger2_rebal_manifest.json (base w4 + c1 w1 + c2 w1)"
cat > "${SDA}/data/gym_drone_game_dreamer4/drone_v6_dagger2_rebal_manifest.json" <<EOF
{
  "name": "gym_drone_game_dreamer4_v6_dagger2_rebal",
  "action_dim": 9,
  "action_features": "current",
  "action_frame_offset": -1,
  "tasks_json": "${W}/data/gym_drone_game_dreamer4/drone_v2_pad_rtg/tasks.json",
  "sources": [
    {"name": "gym_drone_game", "raw": "${W}/data/gym_drone_game_dreamer4/drone_v2_pad_rtg/raw", "frames": "${W}/data/gym_drone_game_dreamer4/drone_v2_pad_rtg/frames", "weight": 4},
...
st "[2/5] planner seed1 (drone_game_v10_dagger_c2_rebal, SEED=20260710)"
train_planner drone_game_v10_dagger_c2_rebal 20260710

st "[3/5] BC head seed1 -> drone_bc_chunk_head_dagger_c2_rebal.pt"
bc_head drone_game_v10_dagger_c2_rebal drone_bc_chunk_head_dagger_c2_rebal.pt \
  > "${SDA}/output/drone_bc_chunk_head_dagger_c2_rebal_log.txt" 2>&1

st "[4/5] closed-loop eval seed1 n=1000 -> closed_loop_drone_game_v14_dagger_c2_rebal"
closed_loop drone_game_v10_dagger_c2_rebal drone_bc_chunk_head_dagger_c2_rebal.pt \
  closed_loop_drone_game_v14_dagger_c2_rebal

st "[5/5] seed2: planner + BC + eval -> closed_loop_drone_game_v14_dagger_c2_rebal_seed2"
train_planner drone_game_v10_dagger_c2_rebal_seed2 20260711
bc_head drone_game_v10_dagger_c2_rebal_seed2 drone_bc_chunk_head_dagger_c2_rebal_seed2.pt --seed 20260712 \
  > "${SDA}/output/drone_bc_chunk_head_dagger_c2_rebal_seed2_log.txt" 2>&1
closed_loop drone_game_v10_dagger_c2_rebal_seed2 drone_bc_chunk_head_dagger_c2_rebal_seed2.pt \
  closed_loop_drone_game_v14_dagger_c2_rebal_seed2 --seed 20270300
