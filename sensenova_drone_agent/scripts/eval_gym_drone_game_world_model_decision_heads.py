...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate world-model decision heads in the Gym drone game.")
    ...
    parser.add_argument("--policy-logprob-weight", type=float, default=None)
...
def main() -> int:
    ...
    runner = load_world_model_decision_runner(
        args.checkpoint,
        device=args.device,
        policy_logprob_weight=args.policy_logprob_weight,
...
<head>
  <meta charset="utf-8">
  <title>World Model Decision Heads Eval</title>
  <style>
...
<body>
  <h1>World Model Decision Heads Eval</h1>
  <table>
